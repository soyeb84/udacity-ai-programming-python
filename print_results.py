...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print('Model used for classification {}'.format(model))
    ...
    if print_incorrect_dogs and (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs']) != results_stats_dic['n_images']:
        for key, value in results_dic.items():
            if sum(value[3:]) == 1:
                print('Misclassified dog - pet label {}, classifier label {}'.format(value[0], value[1]))
    ...
    if print_incorrect_dogs and results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']:
        for key, value in results_dic.items():
            if sum(value[3:]) == 2 and value[2] == 0 :
                print('Misclassified breed - pet label {}, classifier label {}'.format(value[0], value[1]))
